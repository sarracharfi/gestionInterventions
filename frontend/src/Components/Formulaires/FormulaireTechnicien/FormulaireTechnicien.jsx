...
import { MdEmail, MdBuild, MdBusiness } from "react-icons/md";  
import { useLocation, useNavigate } from "react-router-dom";
import Navbar from "../../Navbar/Navbar";
import SignUpModal from "../../SignUp/SignUpModal";
import LoginModal from "../../Login/LoginModal";
import { getUsers, createTechnicien, signIn } from "../../Services/userservice";
import "./formulairetechnicien.css";
...
const FormulaireTechnicien = () => {
  ...
  if (role !== "technicien") {
    return <div>Accès invalide au formulaire technicien</div>;
  }
  ...
  const validateField = (name, value) => {
    ...
    switch (name) {
      ...
      case "prenom":
        ...
        break;
      case "specialite":
        if (!value) error = "Spécialité requise";
        break;
      case "entreprise":
        if (!value) error = "Nom de l’entreprise requis";
        break;
      default:
        break;
    }
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      await createTechnicien(formData);  // Utilisation de createTechnicien
      setFormError("");
  ...
  const handleSignIn = async (e) => {
    ...
    try {
      ...
      alert(`Bienvenue ${res.user?.nom || "Technicien"} !`);
      setFormError("");
      navigate("/profiles/technicien");
    } catch (error) {
        ...
        <div className="forms-container">
          <div className="signin-signup">
            ...
            <form onSubmit={handleSignIn} className="sign-in-form">
              <h2 className="title">Connexion Technicien</h2>
            ...
            <form onSubmit={handleSignUp} className="sign-up-form">
              <h2 className="title">Inscription Technicien</h2>
              {formError && <div className="form-error">{formError}</div>}
              ...
              <div className="input-field">
                ...
                <input
                  ...
                  required
                />
                {errors.specialite && <small className="error-text">{errors.specialite}</small>}
              </div>
              ...
              <div className="input-field">
                ...
                <input
                  ...
                  required
                />
                {errors.entreprise && <small className="error-text">{errors.entreprise}</small>}
              </div>
